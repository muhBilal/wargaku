...
class _HelpSupportState extends State<HelpSupport> {
  ...
  final _loremIpsum =
      "Open the wargaku app to get started and follow the\nsteps. wargaku doesn't charge a fee to create or\nmaintain your wargaku account.";
